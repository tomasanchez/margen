...
- 2026-08-29: superseded by ADR-211 — the generation mechanism (hand-drawn PyMuPDF) and visual design are replaced by an HTML/CSS Jinja template rendered via WeasyPrint, matching the owner-supplied "Estado de cuenta entre amigos" design. All data/content decisions recorded above (bilingual language, owner-name, covered/pardoned section, payments-received history, no dashes, ARS amounts, net-worth isolation) are retained unchanged by ADR-211.
