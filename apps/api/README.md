...
**Margen API** is a [FastAPI](https://fastapi.tiangolo.com/) service following the
...
| FASTAPI_PROJECT_NAME         | Swagger Title                               | Margen API                               |
| FASTAPI_PROJECT_DESCRIPTION  | Swagger Description                         | Margen backend API                         |
...
FASTAPI_PROJECT_CONTACT='{"name": "Tomas Sanchez", "url": "https://github.com/tomasanchez", "email": "tomas.sanchez@wheels.com"}'
```
...
| Name                        | Description                              | Default Value                          |
|-----------------------------|------------------------------------------|----------------------------------------|
| DATABASE_URL                | SQLAlchemy database URL                  | postgresql+asyncpg://margen-api:margen-api@localhost:5432/margen-api |
...
1. Clone the repository
    ...
    ```bash
    git clone "git@github.com:tomasanchez/margen-api.git"
    ```
2. Install dependencies

    ```bash
    cd margen-api && uv sync --dev
    ```
...
This project was generated by [Tomas Sanchez](https://github.com/tomasanchez) <[tomas.sanchez@wheels.com](mailto:tomas.sanchez@wheels.com)>.
