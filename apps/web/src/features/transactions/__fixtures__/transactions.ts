...
const FIXTURE_ROWS: readonly Omit<Transaction, 'occurredOn'>[] = [
  ...
  { id: fid(2), dispDate: 'Jun 11', month: 'June', name: 'Coto supermarket', category: 'Food', bank: 'Galicia', currency: 'ARS', type: 'expense', kind: 'expense', amountNum: 38400 },
  { id: fid(3), dispDate: 'Jun 10', month: 'June', name: 'Netflix · Spotify', category: 'Subscriptions', bank: 'Galicia', currency: 'ARS', type: 'expense', kind: 'expense', amountNum: 14200, recurring: true },
  ...
  { id: fid(7), dispDate: 'Jun 06', month: 'June', name: 'Farmacity', category: 'Health', bank: 'Galicia', currency: 'ARS', type: 'expense', kind: 'expense', amountNum: 22300 },
  ...
  { id: fid(9), dispDate: 'Jun 03', month: 'June', name: 'AWS', category: 'Subscriptions', bank: 'Galicia', currency: 'USD', type: 'expense', kind: 'expense', amountNum: 39616, usd: 32, rate: 1238, recurring: true },
  ...
  { id: fid(11), dispDate: 'May 24', month: 'May', name: 'Carrefour', category: 'Food', bank: 'Santander', card: 'AMEX ·1234', currency: 'ARS', type: 'expense', kind: 'expense', amountNum: 41200 },
  { id: fid(12), dispDate: 'May 20', month: 'May', name: 'Edenor (electricity)', category: 'Services', bank: 'Galicia', currency: 'ARS', type: 'expense', kind: 'expense', amountNum: 33500, recurring: true },
  { id: fid(13), dispDate: 'May 15', month: 'May', name: 'YPF fuel', category: 'Transport', bank: 'Santander', card: 'VISA ·5771', currency: 'ARS', type: 'expense', kind: 'expense', amountNum: 28000 },
  ...
  { id: fid(16), dispDate: 'May 05', month: 'May', name: 'Spotify · Netflix', category: 'Subscriptions', bank: 'Galicia', currency: 'ARS', type: 'expense', kind: 'expense', amountNum: 13900, recurring: true },
  ...
  { id: fid(18), dispDate: 'Apr 18', month: 'April', name: 'Coto', category: 'Food', bank: 'Galicia', currency: 'ARS', type: 'expense', kind: 'expense', amountNum: 37800 },
